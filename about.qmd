...
![](images/drone.jpg){.hero-image fig-alt="Advanced data analysis and environmental monitoring"}
...
![](images/ag-coast.jpg){.section-image fig-alt="Agricultural landscape"}

![](images/steavenson.jpg){.section-image fig-alt="Agricultural landscape"}
:::
:::
...
:::
::: {.g-col-md-4}
![Water Management](images/mdb_mgmt.png){.section-image fig-alt="Watershed management"}

![Agricultural Systems](images/ag-landscape.jpg){.section-image fig-alt="Agricultural landscape"}
:::
:::
