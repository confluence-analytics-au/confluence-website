...
::: {.hero-content}
::: {.hero-text-card}
![](logo_words-01.png){.hero-logo fig-alt="Confluence Analytics Logo"}
...
![](images/drone2.jpg){.hero-bg fig-alt="Environmental monitoring and water management"}
:::
:::
:::
...
:::
::: {.g-col-md-4}
![Data and Modelling](images/all_anaes.png){.section-image fig-alt="Advanced data analysis and modelling techniques"}
:::
:::
...
[Contact us](contact.qmd){.btn .btn-primary .btn-lg role="button"}
:::
